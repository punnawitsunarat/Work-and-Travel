...
def calculate_precise_employer_hours(emp_name, state_name, state_code, pos_name, agency):
    ...
    # 2. Mega National Park Lodges & Concessionaires (Yellowstone Xanterra, Grand Teton GTLC, Glacier National Park, Yosemite DNC, Crater Lake, Zion, Grand Canyon)
    ...
    # 3. Mega Outdoor Theme Parks (Cedar Point, Kings Island, Six Flags, Carowinds, Busch Gardens, Dollywood, Silver Dollar City, Morey's, Palace Playland, Lagoon)
    ...
    # 4. Giant Indoor/Outdoor Waterpark Resorts (Kalahari Resort 900+ suites, Wilderness Resort 1,000+ rooms, Chula Vista, Mt. Olympus, Noah's Ark, White Water)
    ...
    # 5. Mega Luxury 4-5 Diamond Historic Resorts (Grand Hotel Mackinac 397 rooms, Omni Mount Washington, Four Seasons, Tenaya Lodge, Kiawah Island 500+ rooms, Cliff House, Sagamore)
    ...
    # 6. Small Motels, Roadside Inns & 20-50 Room Boutique Inns (Motel 6, Eureka Inn, Sea Latch, Cherry Tree, Brighton Suites, small local inns)
    ...
    # 7. Mid-Scale Standard Hotels (Marriott, Hilton, Westgate, Fairfield, Courtyard, Holiday Inn, Hyatt, Sheraton - 100-250 rooms)
    ...
    # 8. Famous Mega-Restaurants, Landmark Pizzerias & Waterfront Seafood (Moosejaw 600 seats, Buffalo Phil's, Shady Gators, Fudpucker's, Bayou Bill's, Paula Deen's, MudHen, Prospectors)
    ...
    # 11. Ice Cream, Fudge, Candy & Island Tourist Shops (Kilwins, Kohr Bros, The Fudgery, Duck Donuts, Marble Slab, Bargain World)
    ...
    # 12. General Resort / Island / Beach Town
