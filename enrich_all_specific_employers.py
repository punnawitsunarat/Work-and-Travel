...
# -------------------------------------------------------------------------
SPECIFIC_EMPLOYER_DB = {
    # High-end Resorts & Luxury Landmarks
    'tenaya lodge': ('Resort Worker / Food Service / Housekeeping', 16.50, 105, True),
    'everline resort': ('Resort Attendant / Housekeeping / F&B', 17.50, 135, False),
    'the ritz-carlton bachelor gulch': ('Resort Attendant / Steward / Housekeeping', 18.00, 140, False),
    'grand hotel': ('Dining Room Server Assistant / Housekeeping', 15.50, 95, True),
    'cliff house': ('Food Runner / Room Attendant', 17.00, 125, False),
    'omni mount washington': ('Resort Attendant / Culinary / Housekeeping', 15.50, 100, False),
    'the stanley hotel': ('Guest Services / Food Prep / Housekeeping', 16.00, 110, False),
    'trapp family lodge': ('Resort Worker / Housekeeping / F&B', 16.50, 100, False),
    'the lodge at spruce peak': ('Housekeeping / Culinary Prep / F&B', 16.50, 120, False),
    'the equinox golf resort': ('Housekeeping / Food Service', 16.50, 115, False),
    'samoset resort': ('Housekeeping / Food Runner', 16.00, 110, False),
    'the westin portland harborview': ('Room Attendant / Steward', 16.50, 125, False),
    'sea crest beach hotel': ('Housekeeping / Food Service', 16.50, 125, False),
    'newport harbor island resort': ('Food Runner / Housekeeping', 16.00, 130, False),
    'block island beach house': ('Food Runner / Housekeeping', 16.50, 120, False),
    'century country club': ('Dining Room Attendant / Busser', 17.00, 100, False),
    'the palms hotel fire island': ('Housekeeping / Guest Services', 17.00, 120, False),
    'the queensbury hotel': ('Housekeeping / Banquet Server', 16.00, 100, False),
    'turning stone resort': ('Housekeeping / Food Prep', 16.00, 100, False),
    'horseshoe bay resort': ('Resort Associate / Food Service', 14.50, 95, False),
    'sunriver resort': ('Housekeeping / Recreation Attendant', 16.00, 110, False),
    'snow king resort': ('Housekeeping / Activities Host', 16.00, 115, False),
    'yellowstone club': ('Steward / Housekeeping Attendant', 18.50, 100, True),
    'crystal mountain resort': ('Resort Worker / Housekeeping', 14.50, 90, False),
    'inn at bay harbor': ('Housekeeping / Food Runner', 15.00, 100, False),
    'smugglers notch resort': ('Activities Host / Food Service / Housekeeping', 15.00, 95, False),
    'chateau on the lake': ('Housekeeping / Food Service', 14.00, 90, False),
    'camden resort': ('Housekeeping / Resort Associate', 14.00, 90, False),
    'lodge of the ozarks': ('Housekeeping / Front Desk', 14.00, 85, False),

    # National Park Concessions & Lodges
    'grand canyon lodge at north grand canyon': ('Resort Worker / Food Service / Housekeeping', 15.50, 75, True),
    'squire inn resort': ('Housekeeping / Front Desk / Food Service', 15.50, 85, False),
    'the grand hotel xanterra': ('Housekeeping / Food Prep', 15.50, 65, True),
    'dnc at kings canyon': ('Food Service / Retail / Housekeeping', 16.50, 75, True),
    'dnc at yellowstone': ('General Store Clerk / Food Service', 15.00, 70, True),
    'delaware north at sequoia': ('Retail / Food Service / Housekeeping', 16.50, 75, True),
    'the lodge at bryce canyon': ('Food Service / Housekeeping', 14.50, 75, True),
    'zion national park lodge': ('Food Service / Housekeeping', 14.50, 75, True),
    'aramark destinations north lake powell': ('Marina Attendant / Housekeeping / F&B', 15.00, 80, False),
    'interlochen center for the arts': ('Camp Dining Staff / Housekeeping', 14.00, 95, True),
    'under canvas': ('Housekeeping & Laundry Attendant', 14.00, 0, False),

    # Theme Parks & Attractions
    'six flags great adventure': ('Ride Operator / Food Service / Admissions', 15.50, 110, False),
    'six flags hurricane harbor': ('Lifeguard / Park Services', 14.50, 95, False),
    'busch gardens williamsburg': ('Attractions Host / Culinary Associate', 14.50, 100, False),
    'story land theme park': ('Ride Operator / Food Service', 14.50, 95, False),
    'atlantic fun park': ('Ride Operator / Cashier', 14.00, 100, False),
    'lagoon amusement park': ('Ride Operator / Food Service', 14.00, 90, False),
    'seaworld': ('Park Attendant / Ride Operator / Food Service', 14.00, 95, False),
    'dorney park': ('Ride Operator / Food Service / Lifeguard', 15.00, 100, False),
    'palace playland': ('Ride Operator / Cashier / Arcade', 15.00, 100, False),
    'great wolf lodge': ('Lifeguard / Attractions / Housekeeping', 15.00, 95, False),
    'camelback resort': ('Lifeguard / Food Service / Housekeeping', 15.00, 100, False),
    'dells escape room': ('Game Master / Customer Service', 14.50, 90, False),
    'dells resort-the land of natura': ('Attractions Host / Food Service', 14.50, 90, False),
    'gateway 26 casino arcade': ('Arcade Attendant / Cashier', 15.25, 110, False),
    'big top arcade': ('Arcade Attendant / Admissions', 14.00, 95, False),
    'alcatraz east': ('Retail Associate / Admissions Host', 14.00, 95, False),
    'wonderworks': ('Attractions Host / Arcade / Admissions', 14.00, 95, False),
    'wall drug store': ('Retail Associate / Food Service', 15.00, 85, False),

    # Iconic Landmark Restaurants, Bars & Food Hotspots
    'shady gators': ('Busser / Food Runner / Barback', 14.00, 127, False),
    'fudpucker': ('Busser / Food Prep / Host', 14.00, 210, False),
    'moosejaw pizza': ('Pizza Cook / Food Runner / Busser', 13.00, 120, False),
    'buffalo phil': ('Food Runner / Busser / Prep Cook', 13.50, 110, False),
    'paula deen': ('Host / Busser / Kitchen Prep', 14.00, 100, False),
    'boudin bakery': ('Bakery Associate / Food Prep / Cashier', 19.18, 150, False),
    'kohr bros': ('Frozen Custard Scooper / Cashier', 15.13, 175, False),
    'thrasher': ('Fry Cook / Cashier', 15.00, 140, False),
    'curley': ('Fry Cook / Cashier', 15.13, 110, False),
    'kilwins': ('Fudge Maker / Ice Cream Scooper / Cashier', 14.50, 120, False),
    'george\'s candy': ('Candy Maker / Cashier', 15.13, 110, False),
    'dolle\'s candy': ('Saltwater Taffy Maker / Cashier', 15.00, 120, False),
    'gigi\'s new your style pizza': ('Pizza Cook / Cashier', 15.50, 115, False),
    'cameo pizza': ('Pizza Cook / Food Runner', 14.50, 90, False),
    'dough boys pizza': ('Pizza Cook / Food Runner', 14.50, 100, False),
    'dough roller': ('Food Runner / Kitchen Prep / Cashier', 15.00, 120, False),
    'buona vita pizzeria': ('Pizza Prep / Server Assistant', 15.00, 120, False),
    'black pelican oceanfront': ('Busser / Food Runner', 14.50, 110, False),
    'dirty dick\'s crab house': ('Busser / Food Runner', 14.50, 110, False),
    'bros sandwich shop': ('Sandwich Maker / Cashier', 14.00, 100, False),
    'george\'s of galilee': ('Busser / Kitchen Helper', 15.50, 120, False),
    'island pancake house': ('Pancake Cook / Busser / Food Runner', 13.50, 100, False),
    'door county ice cream factory': ('Ice Cream Scooper / Cashier', 14.50, 90, False),
    'big buck\'s ice cream': ('Ice Cream Scooper / Cashier', 14.00, 100, False),
    'ricciardi\'s italian ice': ('Italian Ice Scooper / Cashier', 14.00, 100, False),
    'bubba gump shrimp': ('Host / Busser / Food Runner', 14.50, 100, False),
    'steak \'n shake': ('Crew Member / Cook / Cashier', 14.00, 90, False),
    'texas roadhouse': ('Busser / Food Runner / Host', 14.00, 95, False),
    'chick-fil-a': ('Team Member / Cashier / Kitchen', 14.50, 95, False),
    'ban ban burger': ('Line Cook / Cashier / Food Prep', 16.50, 135, False),
    'toss noodle bar': ('Food Prep / Cashier / Server Assistant', 16.50, 135, False),
    'farmhouse kitchen thai': ('Busser / Food Runner / Food Prep', 16.00, 105, True),
    'mahaniyom restaurant': ('Food Preparation / Kitchen Assistant', 15.00, 105, True),
    'sugar & spice thai': ('Busser / Food Runner', 16.00, 105, True),
    'baitong restaurant': ('Food Runner / Kitchen Helper', 17.50, 140, True),
    'noi cuisine': ('Food Runner / Server Assistant', 17.50, 140, True),
    'sister ship': ('Food Runner / Server Assistant', 17.00, 135, False),
    'marie eiffel market': ('Deli Clerk / Cashier / Barista', 17.00, 130, False),
    'spenard roadhouse': ('Busser / Food Runner / Dishwasher', 15.50, 110, False),
    'south restaurant': ('Busser / Food Runner', 15.50, 110, False),
    'crush bistro': ('Food Runner / Kitchen Prep', 15.50, 110, False),
    'indian valley meats': ('Meat Packaging / Production Assistant', 16.00, 100, False),
    'chilkat restaurant': ('Baker Assistant / Food Service', 15.00, 100, True),

    # Supermarkets & Retail
    'safeway': ('Retail Clerk / Cashier / Deli Assistant', 17.00, 120, False),
    'food lion': ('Cashier / Stocker / Deli Associate', 14.50, 100, False),
    'hannaford': ('Cashier / Stocker / Bakery Clerk', 16.00, 110, False),
    'shaw\'s': ('Cashier / Grocery Clerk', 16.00, 120, False),
    'eagles beachwear': ('Retail Sales Associate / Cashier', 14.00, 100, False),
    'bargain beachwear': ('Retail Sales Associate / Cashier', 14.00, 100, False),
    'sunsations': ('Retail Associate / Cashier / Stocker', 15.50, 115, False),
    'coastal caps': ('Retail Associate / Cashier', 15.13, 110, False),
    'stuey': ('Juice Bar Associate / Cashier', 15.13, 110, False),
    'hollywood pictures': ('Photographer / Retail Sales', 14.00, 100, False),
    'country house gift': ('Retail Sales Associate', 14.50, 90, False),
    'travel traders': ('Retail Sales Associate / Barista', 16.50, 135, False),

    # Fast Casual & Quick Service
    'mcdonald': ('Crew Member / Cashier / Cook', 14.50, 100, False),
    'wendy': ('Crew Member / Cashier / Cook', 14.00, 95, False),
    'dairy queen': ('Crew Member / Ice Cream Scooper / Cashier', 14.00, 95, False),
    'dunkin': ('Crew Member / Barista / Cashier', 14.50, 100, False),
    'subway': ('Sandwich Artist / Cashier', 14.00, 95, False),
    'midnight sun subway': ('Sandwich Artist / Cashier', 15.00, 110, False),
    'popeyes': ('Crew Member / Fry Cook / Cashier', 15.00, 100, False),
    'blaze pizza': ('Pizza Line Member / Cashier', 15.00, 110, False),
    'auntie anne': ('Crew Member / Pretzel Roller / Cashier', 14.00, 95, False),
    'cinnabon': ('Crew Member / Baker / Cashier', 14.00, 95, False),

    # Hotels & Motels
    'anaheim majestic garden hotel': ('Housekeeping / Food Service', 16.50, 90, False),
    'camp richardson resort': ('Marina Attendant / Housekeeping / Scooper', 16.50, 100, False),
    'margaritaville resort': ('Pool Attendant / Food Runner / Housekeeping', 16.50, 125, False),
    'eureka inn': ('Housekeeping / Room Attendant', 16.50, 0, False),
    'lakeshore resort': ('Resort Attendant / Housekeeping / F&B', 16.50, 98, False),
    'deadwood gulch': ('Housekeeping / Food Service / Casino Host', 14.50, 90, False),
    'northland hotel': ('Housekeeping / Room Attendant', 15.50, 90, False),
    'cody holiday lodge': ('Housekeeping / Room Attendant', 14.00, 80, False),
    'wigwam motel': ('Housekeeping / Room Attendant', 14.00, 80, False),
    'brighton suites': ('Housekeeping / Room Attendant', 15.00, 110, False),
    'harbor base pineapple inn': ('Housekeeping / Room Attendant', 16.00, 120, False),
    'flagstone motel': ('Housekeeping / Room Attendant', 16.50, 110, False),
    'best western': ('Housekeeping / Breakfast Attendant', 14.50, 90, False),
    'comfort inn': ('Housekeeping / Laundry Attendant', 14.50, 90, False),
    'days inn': ('Housekeeping / Room Attendant', 14.50, 90, False),
    'fairfield inn': ('Housekeeping / Breakfast Attendant', 14.25, 95, False),
    'commodore perry inn': ('Housekeeping / Front Desk', 14.50, 90, False),
    'edgewater': ('Housekeeping / Food Service', 14.00, 80, False),
    'aquarius casino': ('Housekeeping / Food Service', 14.00, 80, False),
    'bally\'s lake tahoe': ('Room Attendant / Steward', 15.00, 100, False),
    'circus circus': ('Food Service / Retail Cashier', 14.50, 90, False),
    'motel 6': ('Housekeeping / Laundry Attendant', 15.00, 100, False),
    'hyatt': ('Housekeeping / Steward / Banquet Server', 17.00, 125, False)
}
...
def enrich_position(raw_pos, title_clean, agency, state_code):
    ...
    # 1. Check if raw_pos has valid specific text from agency
    ...
    # 2. Check Specific Employer Database
    for key, val in SPECIFIC_EMPLOYER_DB.items():
        if key in t_low:
            return val[0]
...
def enrich_rate(raw_rate, raw_pos, title_clean, state_code):
    ...
    # 1. Check for explicit Server / Tipped wage pattern like "$5+Tips (OT $7.50+Tips)"
    ...
    # 2. Check for explicit Range in raw_rate (e.g. "$16.00-$17.00")
    ...
    # 3. Check for explicit Rate & OT in combined text (e.g. "$14 (OT $21)")
    ...
    # 4. Check for single rate in raw_rate (e.g. "$15.15 per hour", "$19.18 / Hourly")
    ...
    # 5. Check for single rate in raw_pos
    ...
    # 6. Check Specific Employer Database
    for key, val in SPECIFIC_EMPLOYER_DB.items():
        if key in t_low:
            base_v = val[1]
...
def enrich_housing_and_benefits(emp_name, state_name, state_code, pos_name, raw_housing, raw_desc):
    ...
    # Check Specific Employer Database for Housing & Meals
    for key, val in SPECIFIC_EMPLOYER_DB.items():
        if key in e_low:
            if val[2] == 0: is_free_hsg = True
            if val[3]: has_full_meals = True
            hsg_val_weekly = val[2]
            break
    else:
        hsg_val_weekly = 110
...
print('Specific employer search & enrichment completed successfully for all 1,167 jobs!')
